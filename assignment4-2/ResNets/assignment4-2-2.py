...
'''有点问题，下边这句必须先执行一下，答案才对的上
A = identity_block(tf.placeholder('float', [3, 4, 4, 6]), f=2, filters=[2, 4, 6], stage=1, block='a')
...
'''
A = convolutional_block(tf.placeholder('float', [3, 4, 4, 6]), f=2, filters=[2, 4, 6], stage=1, block='a')
