...
def forward_propagation(X, parameters):
    ...
    P1 = tf.nn.max_pool(value=A1, ksize=(1, 8, 8, 1), strides=(1, 4, 4, 1),padding='SAME')

    Z2 = tf.nn.conv2d(input=P1, filter=W2, strides=(1, 1, 1, 1), padding='SAME')

    A2 = tf.nn.relu(Z2)

    P2 = tf.nn.max_pool(value=A2, ksize=(1, 4, 4, 1), strides=(1, 2, 2, 1), padding='SAME')

    Z3 = tf.contrib.layers.fully_connected(tf.contrib.layers.flatten(P2), 6, activation_fn=None)
